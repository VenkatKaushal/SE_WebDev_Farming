...
const seedCrops = async () => {
    const crops = [
        ...
        },
        {
            ...
            imageUrl: "../services/Pigeon Peas.jpg"
        },
        {
            ...
            imageUrl: "../services/chickpeas.jpg"
        },
        {
            ...
            imageUrl: "../services/Mung beans.jpg"
        },
        {
            name: "Cotton",
            type: "Kharif Crop",
